  ...
  GVariant *parameters)
{
  ...
  num_params = g_variant_n_children (parameters);
  paramv = g_new0 (GValue, num_params + 1);
  g_value_init (&paramv[0], GXDP_TYPE_NETWORK_MONITOR);
  g_value_set_object (&paramv[0], proxy);
  g_variant_iter_init (&iter, parameters);
  n = 1;
  while ((child = g_variant_iter_next_value (&iter)) != NULL)
...
gxdp_network_monitor_proxy_new_for_bus (
    ...
    gpointer             user_data)
{
  g_async_initable_new_async (GXDP_TYPE_NETWORK_MONITOR_PROXY, G_PRIORITY_DEFAULT, cancellable, callback, user_data, "g-flags", flags, "g-name", name, "g-bus-type", bus_type, "g-object-path", object_path, "g-interface-name", "org.freedesktop.portal.NetworkMonitor", NULL);
}
...
{
  GInitable *ret;
  ret = g_initable_new (GXDP_TYPE_NETWORK_MONITOR_PROXY, cancellable, error, "g-flags", flags, "g-name", name, "g-bus-type", bus_type, "g-object-path", object_path, "g-interface-name", "org.freedesktop.portal.NetworkMonitor", NULL);
  if (ret != NULL)
    return GXDP_NETWORK_MONITOR (ret);
  else
    return NULL;
...
struct _GXdpNetworkMonitorSkeletonPrivate
{
  GValue *properties;
  GList *changed_properties;
  GSource *changed_properties_idle_source;
...
static void
_gxdp_network_monitor_skeleton_handle_method_call (
  GDBusConnection *connection G_GNUC_UNUSED,
  const gchar *sender G_GNUC_UNUSED,
  const gchar *object_path G_GNUC_UNUSED,
  const gchar *interface_name,
  ...
  gpointer user_data)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (user_data);
  _ExtendedGDBusMethodInfo *info;
  GVariantIter iter;
  GVariant *child;
  GValue *paramv;
  ...
  num_extra = info->pass_fdlist ? 3 : 2;  paramv = g_new0 (GValue, num_params + num_extra);
  n = 0;
  g_value_init (&paramv[n], GXDP_TYPE_NETWORK_MONITOR);
  g_value_set_object (&paramv[n++], skeleton);
  g_value_init (&paramv[n], G_TYPE_DBUS_METHOD_INVOCATION);
  g_value_set_object (&paramv[n++], invocation);
  if (info->pass_fdlist)
...
static GVariant *
_gxdp_network_monitor_skeleton_handle_get_property (
  GDBusConnection *connection G_GNUC_UNUSED,
  const gchar *sender G_GNUC_UNUSED,
  const gchar *object_path G_GNUC_UNUSED,
  const gchar *interface_name G_GNUC_UNUSED,
  ...
  gpointer user_data)
{
  ...
  GVariant *ret;
  ret = NULL;
  info = (_ExtendedGDBusPropertyInfo *) g_dbus_interface_info_lookup_property ((GDBusInterfaceInfo *) &_gxdp_network_monitor_interface_info.parent_struct, property_name);
  g_assert (info != NULL);
  pspec = g_object_class_find_property (G_OBJECT_GET_CLASS (skeleton), info->hyphen_name);
  if (pspec == NULL)
    {
...
static gboolean
_gxdp_network_monitor_skeleton_handle_set_property (
  GDBusConnection *connection G_GNUC_UNUSED,
  const gchar *sender G_GNUC_UNUSED,
  const gchar *object_path G_GNUC_UNUSED,
  const gchar *interface_name G_GNUC_UNUSED,
...
static const GDBusInterfaceVTable _gxdp_network_monitor_skeleton_vtable =
{
  _gxdp_network_monitor_skeleton_handle_method_call,
  _gxdp_network_monitor_skeleton_handle_get_property,
  _gxdp_network_monitor_skeleton_handle_set_property,
...
static GDBusInterfaceInfo *
gxdp_network_monitor_skeleton_dbus_interface_get_info (GDBusInterfaceSkeleton *skeleton G_GNUC_UNUSED)
{
  return gxdp_network_monitor_interface_info ();
}

static GDBusInterfaceVTable *
gxdp_network_monitor_skeleton_dbus_interface_get_vtable (GDBusInterfaceSkeleton *skeleton G_GNUC_UNUSED)
{
  return (GDBusInterfaceVTable *) &_gxdp_network_monitor_skeleton_vtable;
}

static GVariant *
gxdp_network_monitor_skeleton_dbus_interface_get_properties (GDBusInterfaceSkeleton *_skeleton)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (_skeleton);

  GVariantBuilder builder;
  guint n;
  g_variant_builder_init (&builder, G_VARIANT_TYPE ("a{sv}"));
  if (_gxdp_network_monitor_interface_info.parent_struct.properties == NULL)
    goto out;
  for (n = 0; _gxdp_network_monitor_interface_info.parent_struct.properties[n] != NULL; n++)
    {
      GDBusPropertyInfo *info = _gxdp_network_monitor_interface_info.parent_struct.properties[n];
      if (info->flags & G_DBUS_PROPERTY_INFO_FLAGS_READABLE)
        {
          GVariant *value;
          value = _gxdp_network_monitor_skeleton_handle_get_property (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)), NULL, g_dbus_interface_skeleton_get_object_path (G_DBUS_INTERFACE_SKELETON (skeleton)), "org.freedesktop.portal.NetworkMonitor", info->name, NULL, skeleton);
          if (value != NULL)
            {
              g_variant_take_ref (value);
              g_variant_builder_add (&builder, "{sv}", info->name, value);
...
static gboolean _gxdp_network_monitor_emit_changed (gpointer user_data);

static void
gxdp_network_monitor_skeleton_dbus_interface_flush (GDBusInterfaceSkeleton *_skeleton)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (_skeleton);
  gboolean emit_changed = FALSE;
  ...
  if (emit_changed)
    _gxdp_network_monitor_emit_changed (skeleton);
}

static void
_gxdp_network_monitor_on_signal_changed (
    GXdpNetworkMonitor *object,
    gboolean arg_available)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (object);
...
static void gxdp_network_monitor_skeleton_iface_init (GXdpNetworkMonitorIface *iface);
#if GLIB_VERSION_MAX_ALLOWED >= GLIB_VERSION_2_38
G_DEFINE_TYPE_WITH_CODE (GXdpNetworkMonitorSkeleton, gxdp_network_monitor_skeleton, G_TYPE_DBUS_INTERFACE_SKELETON,
                         G_ADD_PRIVATE (GXdpNetworkMonitorSkeleton)
                         G_IMPLEMENT_INTERFACE (GXDP_TYPE_NETWORK_MONITOR, gxdp_network_monitor_skeleton_iface_init))
...
#endif
static void
gxdp_network_monitor_skeleton_finalize (GObject *object)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (object);
  guint n;
  for (n = 0; n < 3; n++)
  ...
  g_main_context_unref (skeleton->priv->context);
  g_mutex_clear (&skeleton->priv->lock);
  G_OBJECT_CLASS (gxdp_network_monitor_skeleton_parent_class)->finalize (object);
}

static void
gxdp_network_monitor_skeleton_get_property (GObject      *object,
  guint         prop_id,
  GValue       *value,
  GParamSpec   *pspec G_GNUC_UNUSED)
{
...
static gboolean
_gxdp_network_monitor_emit_changed (gpointer user_data)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (user_data);
  GList *l;
  GVariantBuilder builder;
...
static void
_gxdp_network_monitor_schedule_emit_changed (GXdpNetworkMonitorSkeleton *skeleton, const _ExtendedGDBusPropertyInfo *info, guint prop_id, const GValue *orig_value)
{
  ChangedProperty *cp;
  GList *l;
  cp = NULL;
...
static void
gxdp_network_monitor_skeleton_notify (GObject      *object,
  GParamSpec *pspec G_GNUC_UNUSED)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (object);
  g_mutex_lock (&skeleton->priv->lock);
  if (skeleton->priv->changed_properties != NULL &&
      skeleton->priv->changed_properties_idle_source == NULL)
    {
      skeleton->priv->changed_properties_idle_source = g_idle_source_new ();
      g_source_set_priority (skeleton->priv->changed_properties_idle_source, G_PRIORITY_DEFAULT);
      g_source_set_callback (skeleton->priv->changed_properties_idle_source, _gxdp_network_monitor_emit_changed, g_object_ref (skeleton), (GDestroyNotify) g_object_unref);
      g_source_set_name (skeleton->priv->changed_properties_idle_source, "[generated] _gxdp_network_monitor_emit_changed");
      g_source_attach (skeleton->priv->changed_properties_idle_source, skeleton->priv->context);
      g_source_unref (skeleton->priv->changed_properties_idle_source);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
static void
gxdp_network_monitor_skeleton_set_property (GObject      *object,
  guint         prop_id,
  const GValue *value,
  GParamSpec   *pspec)
{
  ...
  if (!_g_value_equal (value, &skeleton->priv->properties[prop_id - 1]))
    {
      if (g_dbus_interface_skeleton_get_connection (G_DBUS_INTERFACE_SKELETON (skeleton)) != NULL)
        _gxdp_network_monitor_schedule_emit_changed (skeleton, _gxdp_network_monitor_property_info_pointers[prop_id - 1], prop_id, &skeleton->priv->properties[prop_id - 1]);
      g_value_copy (value, &skeleton->priv->properties[prop_id - 1]);
      g_object_notify_by_pspec (object, pspec);
    }
  g_mutex_unlock (&skeleton->priv->lock);
...
static void
gxdp_network_monitor_skeleton_init (GXdpNetworkMonitorSkeleton *skeleton)
{
#if GLIB_VERSION_MAX_ALLOWED >= GLIB_VERSION_2_38
  skeleton->priv = gxdp_network_monitor_skeleton_get_instance_private (skeleton);
#else
  skeleton->priv = G_TYPE_INSTANCE_GET_PRIVATE (skeleton, GXDP_TYPE_NETWORK_MONITOR_SKELETON, GXdpNetworkMonitorSkeletonPrivate);
#endif
...
static gboolean 
gxdp_network_monitor_skeleton_get_available (GXdpNetworkMonitor *object)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (object);
  gboolean value;
  g_mutex_lock (&skeleton->priv->lock);
...
static gboolean 
gxdp_network_monitor_skeleton_get_metered (GXdpNetworkMonitor *object)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (object);
  gboolean value;
  g_mutex_lock (&skeleton->priv->lock);
...
static guint 
gxdp_network_monitor_skeleton_get_connectivity (GXdpNetworkMonitor *object)
{
  GXdpNetworkMonitorSkeleton *skeleton = GXDP_NETWORK_MONITOR_SKELETON (object);
  guint value;
  g_mutex_lock (&skeleton->priv->lock);
...
static void
gxdp_network_monitor_skeleton_class_init (GXdpNetworkMonitorSkeletonClass *klass)
{
  GObjectClass *gobject_class;
  GDBusInterfaceSkeletonClass *skeleton_class;

  gobject_class = G_OBJECT_CLASS (klass);
  gobject_class->finalize = gxdp_network_monitor_skeleton_finalize;
  gobject_class->get_property = gxdp_network_monitor_skeleton_get_property;
  gobject_class->set_property = gxdp_network_monitor_skeleton_set_property;
  gobject_class->notify       = gxdp_network_monitor_skeleton_notify;


  gxdp_network_monitor_override_properties (gobject_class, 1);

  skeleton_class = G_DBUS_INTERFACE_SKELETON_CLASS (klass);
  skeleton_class->get_info = gxdp_network_monitor_skeleton_dbus_interface_get_info;
  skeleton_class->get_properties = gxdp_network_monitor_skeleton_dbus_interface_get_properties;
  skeleton_class->flush = gxdp_network_monitor_skeleton_dbus_interface_flush;
  skeleton_class->get_vtable = gxdp_network_monitor_skeleton_dbus_interface_get_vtable;

#if GLIB_VERSION_MAX_ALLOWED < GLIB_VERSION_2_38
  g_type_class_add_private (klass, sizeof (GXdpNetworkMonitorSkeletonPrivate));
#endif
}

static void
gxdp_network_monitor_skeleton_iface_init (GXdpNetworkMonitorIface *iface)
{
  iface->changed = _gxdp_network_monitor_on_signal_changed;
  iface->get_available = gxdp_network_monitor_skeleton_get_available;
  iface->get_metered = gxdp_network_monitor_skeleton_get_metered;
  iface->get_connectivity = gxdp_network_monitor_skeleton_get_connectivity;
}
 ...
 */
GXdpNetworkMonitor *
gxdp_network_monitor_skeleton_new (void)
{
  return GXDP_NETWORK_MONITOR (g_object_new (GXDP_TYPE_NETWORK_MONITOR_SKELETON, NULL));
}
...
static const _ExtendedGDBusArgInfo * const _gxdp_proxy_resolver_method_info_lookup_IN_ARG_pointers[] =
{
...
static const _ExtendedGDBusArgInfo * const _gxdp_proxy_resolver_method_info_lookup_OUT_ARG_pointers[] =
{
  &_gxdp_proxy_resolver_method_info_lookup_OUT_ARG_proxies,
  NULL
};
...
static const _ExtendedGDBusMethodInfo * const _gxdp_proxy_resolver_method_info_pointers[] =
{
  &_gxdp_proxy_resolver_method_info_lookup,
  NULL
};
